...
def main():
    ...
    opentitan_dir = os.path.abspath(os.path.join(script_dir, "../../drivers/uart_opentitan/thirdparty/opentitan"))
    ...
    parser = argparse.ArgumentParser(description = "Generate headers for embedded IPs for Chimera-SDK")
    parser.add_argument(
        "--output",
        type = str,
        required = True,

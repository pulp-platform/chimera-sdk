...
def main():
    ...
    reg_ips = {
        "uart", "adc_ctrl", "aes", "aon", "csrng", "alert_handler",
        "aon_timer", "clkmgr", "edn", "entropy_src", "flash_ctrl", "gpio",
        "hmac", "i2c", "keymgr", "keymgr_dpe", "kmac", "lc_ctrl", "otbn",
        "otp_ctrl", "pattgen", "pinmux", "pwm", "pwrmgr", "rom_ctrl", "rstmgr",
    ...
    cmd_dttool_top = [
        dttool_py, "--topgencfg", autogen_hjson, "--outdir", args.output,
        "--gen-top"
    ]

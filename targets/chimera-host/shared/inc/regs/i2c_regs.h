...
#define I2C_FIFO_CTRL_FMTILVL_FIELD \
    ((bitfield_field32_t){.mask = I2C_FIFO_CTRL_FMTILVL_MASK, \
...
#define I2C_FIFO_STATUS_FMTLVL_FIELD \
    ((bitfield_field32_t){.mask = I2C_FIFO_STATUS_FMTLVL_MASK, \
...
#define I2C_FIFO_STATUS_TXLVL_FIELD \
    ((bitfield_field32_t){.mask = I2C_FIFO_STATUS_TXLVL_MASK, \
                          .index = I2C_FIFO_STATUS_TXLVL_OFFSET})
#define I2C_FIFO_STATUS_RXLVL_MASK 0x7f
#define I2C_FIFO_STATUS_RXLVL_OFFSET 16
#define I2C_FIFO_STATUS_RXLVL_FIELD \
    ((bitfield_field32_t){.mask = I2C_FIFO_STATUS_RXLVL_MASK, \
...
#define I2C_FIFO_STATUS_ACQLVL_FIELD \
    ((bitfield_field32_t){.mask = I2C_FIFO_STATUS_ACQLVL_MASK, \
                          .index = I2C_FIFO_STATUS_ACQLVL_OFFSET})
...
#define I2C_TARGET_ID_ADDRESS0_FIELD \
    ((bitfield_field32_t){.mask = I2C_TARGET_ID_ADDRESS0_MASK, \
                          .index = I2C_TARGET_ID_ADDRESS0_OFFSET})
...
#define I2C_TARGET_ID_ADDRESS1_FIELD \
    ((bitfield_field32_t){.mask = I2C_TARGET_ID_ADDRESS1_MASK, \
                          .index = I2C_TARGET_ID_ADDRESS1_OFFSET})
